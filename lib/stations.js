    ...
    se: [
      {
        ...
        type: "beach",
        directions: [
          {direction: "Oceanfront South", path: "VBS"},
          {direction: "Oceanfront North", path: "VBN"},
          {direction: "Pungo", path: "VBP"},
          {direction: "Chick's Beach", path: "VBC"}
        ]
      } ,
      {
        line: "North Carolina",
        ...
        type: "beach",
        directions: [
          {direction: "Duck", path: "NCD"},
          {direction: "Kill Devil Hills", path: "NCK"},
          {direction: "Nags Head", path: "NCN"},
          {direction: "Hatteras", path: "NCH"},
          {direction: "Ocaracoke", path: "NCO"}
        ]
      }
    ]
  };
